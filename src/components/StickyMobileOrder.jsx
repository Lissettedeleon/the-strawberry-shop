...
const platforms = [
  { name: "Order Direct (Toast)", url: "https://order.toasttab.com/online/the-strawberry-shop-7100-foundry-row", emoji: "🍓" },
  { name: "Uber Eats", url: "https://www.ubereats.com/store/the-strawberry-shop-7100-foundry-row/sBLlZJJpWzytPViiGPa2Fg", emoji: "🚗" },
  { name: "DoorDash", url: "https://www.doordash.com/store/41748513", emoji: "🏃" },
];
