...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-24 relative z-10 text-center">
        <motion.h1
        ...
        <motion.p
          ...
          className="text-[#5C0110]/80 font-body text-base md:text-lg mb-8 max-w-xl mx-auto leading-relaxed"
        >
