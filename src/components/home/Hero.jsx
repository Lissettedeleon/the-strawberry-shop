...
const HERO_IMAGE =
  "https://media.base44.com/images/public/6a34ab1480a9a94dcd8377fa/26660c2e8_generated_image.png";
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-center">
          ...
          >
            <div className="relative rounded-[28px] overflow-hidden shadow-2xl border-4 border-white aspect-[4/3] md:aspect-[5/4] bg-[#F6E3E7]">
              <img
                src={HERO_IMAGE}
                alt="Fresh chocolate-covered strawberries from The Strawberry Shop"
