  ...
  return (
    <>
      <motion.div
        ...
        className="bg-card rounded-[28px_10px_28px_10px] overflow-hidden shadow-sm border-2 border-border hover:border-primary/30 hover:shadow-lg transition-all group relative cursor-pointer"
      >
        {/* Sparkle on hover */}
