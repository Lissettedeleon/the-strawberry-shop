...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section style={{ background: "linear-gradient(135deg, #7C0116 0%, #5C0110 100%)" }} className="relative overflow-hidden pb-16">
        <PowderAccent />
        {HERO_DOODLES.map((d, i) => (
          <span
            key={i}
            className="absolute rounded-full border border-white/25 pointer-events-none"
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-[36px] px-4 sm:px-10 py-10 md:py-14" style={{ backgroundColor: "#F7E3E8" }}>
            <div className="text-center mb-8">
              <h2 className="font-bubble text-[#7C0116] text-2xl md:text-3xl mb-3">what people are saying</h2>
              <div className="inline-flex items-center gap-3 bg-white border border-[#E0A4B0] rounded-full px-5 py-2.5 mb-4">
              ...
              <div className="mt-3">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-white border border-[#E0A4B0] rounded-full px-4 py-2 text-sm font-body font-semibold text-[#1a1a1a] hover:bg-[#FBF1F3] transition-colors shadow-sm"
                >
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="font-bubble text-[#7C0116] text-2xl md:text-3xl">find us on social</h2>
          </div>
          <SocialFeed />
        </div>
      </section>
      ...
      <section style={{ background: "linear-gradient(135deg, #7C0116 0%, #5C0110 100%)" }} className="py-14 md:py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="font-bubble text-white text-2xl sm:text-3xl mb-3 drop-shadow-lg">craving something sweet?</h2>
